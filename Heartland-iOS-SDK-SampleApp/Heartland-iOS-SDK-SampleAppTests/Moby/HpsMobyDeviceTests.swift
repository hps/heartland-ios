...
final class HpsMobyDeviceTests: XCTestCase, HpsMobyDeviceDelegate, HpsMobyTransactionDelegate {
    ...
    func testInitialize() {
        deviceConnectionExpectation = expectation(description: "test_Moby_Initialize")
