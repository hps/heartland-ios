...
typedef  enum  : NSUInteger{
    ...
    RUAErrorCodeRepackageUNSInvalidFilePath = 105,
    
    RUAErrorCodeRepackageUNSIdenticalUNSFile = 106,
    
    RUAErrorCodeRepackageUNSFailed = 107,
    
    RUAErrorCodeTipEntryAborted = 108,
	
	/** 8E84 Card not present or not fully inserted */
	RUAErrorCodeCardNotPresentOrNotFullyInserted = 109,
 
    /** 8E07 InvalidDataTransmitted */
    RUAErrorCodeInvalidDataTransmitted = 110,
    
    /** 8F11 AESDUKPT key not found. */
    RUAErrorCodeAESDUKPTKeyNotFound = 111,
    
    RUAErrorCodeCustomMenuSelectionAborted = 112,
    
    RUAErrorCodeRsaOaepInvalidRequest = 113,
    
    RUAErrorCodeRsaOaepKeyWithSameNameExists = 114,
    
    RUAErrorCodeRsaOaepSignatureCheckFailed = 115,
    
    RUAErrorCodeRsaOaepFileSystemfailure = 116,
    
    RUAErrorCodeRsaOaepKeyCurrentlyInUse = 117,
    
    RUAErrorCodeRsaOaepKeyNotFound = 118,
    
    RUAErrorCodeRsaOaepInvalidPublicKey = 119,
    
    RUAErrorCodeRsaOaepParentCertificateNotFound = 120,
    
    RUAErrorCodeRsaOaepValidationFailed = 121,
    
    RUAErrorCodeRsaOaepPrimaryKeyNotFound = 122,
    
    RUAErrorCodeRsaOaepEncyryptionKeyIdNotFound = 123,
    
    /** 8E03 Instruction not supported by this reader. */
    RUAErrorCodeInvalidInstruction = 124,

    /** C182 Timed out waiting for handle (SMC) */
    RUAErrorCodeTimedoutWaitingForHandle = 125,
    
    /** C183 Unable to obtain handle (SMC) */
    RUAErrorCodeUnableToObtainHandle = 126,
    
    /** 8200 Power could not be applied to card */
    RUAErrorCodePowerCannotBeAppliedToCard = 127,
    
    /** 8201 Card is drawing too much current */
    RUAErrorCodeCardDrawingTooMuchCurrent = 128,
    
    /** 8E85 Card is not powered up */
    RUAErrorCodeCardNotPoweredUp = 129,
    
    /** 8E00 Card reader not responding*/
    RUAErrorCodeCardReaderNotResponding = 130,
    
    /** 8E01 Invalid Overall Command Length*/
    RUAErrorCodeInvalidOverallCommandLength = 131,
    
    /** 8E06 Transmitted Data Length does not match specified length byte*/
    RUAErrorCodeTransmittedDataLengthMismatch = 132,
    
    /** 8E08 Last Transmitted byte is not ‘00’*/
    RUAErrorCodeInvalidCommandTerminator = 133,
    
    /** 8E82 Card reader communications error*/
    RUAErrorCodeCardReaderCommunicationsError = 134,
    
    /** 8E83 Card reader rejected command*/
    RUAErrorCodeCardReaderRejectedCommand = 135,
    
    /** C18B Contactless transaction requires a fallback to present another card message*/
    RUAErrorCodeContactlessRequiredFallback = 136,
    
    /** C18C Mismatched overall firmware custom version*/
    RUAErrorCodeMismatchedOverallFirmwareCustomVersion = 137,
    
    /** C18D Mismatched dynamic config custom version */
    RUAErrorCodeMismatchedDynamicConfigCustomVersion = 138,
    
    /** C18E Mismatched static software custom version*/
    RUAErrorCodeMismatchedStaticSoftwareCustomVersion = 139,
    
    /** 8F12 AES DUKPT PIN encryption/MAC calculation failed*/
    RUAErrorAesDuKptPinEncryptionCaluclationFailed = 140,
    
    RUAErrorKeyExpired = 141,
    
    RUAErrorKeyNotFounded = 142,
    
    RUAErrorKeyExchangeRequiredByUI = 143,
    
    RUAErrorDuKptMaximumEncrytptionReached = 144,
    
    RUAErrorNoMoreKeyExchangePossible = 145,
    
    RUAErrorKeyInjectionErrorVerifyMac = 146,
    
    RUAErrorKeyInjectionErrorVerifyKSN = 147,
    
    RUAErrorKeyInjectionErrorVerifyIPEKLength = 148,
    
    RUAErrorKeyInjectionErrorVerifyHash = 149
...
typedef enum {
    ...
    /** Contact Quick Chip EMV response dol. */
    RUAResponseTypeContactQuickChipEMVResponseDOL = 109,
    /** Apple VAS response */
    RUAResponseTypeAppleVASResponse = 110,
