...
typedef NS_ENUM (NSInteger, RUACommand) {
    ...
    */
    ...
    RUACommandPredifinedScreen = 103,
    
    RUACommandPairing = 104,
    
    RUAEchoCommand = 105,
    
    RUACommandSetE2EECustomConfig = 106,
    
    RUACommandResetE2EECustomConfig = 107,
    
    RUACommandSetE2EEObfuscationLevel = 108,
    
    RUACommandGetE2EECustomConfig = 109,

    RUACommandGetLastErrorCommand = 110,
    
    RUADestroyDeviceConfig = 111
};
