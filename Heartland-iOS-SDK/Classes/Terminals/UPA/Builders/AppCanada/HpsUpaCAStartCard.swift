//
//  HpsUpaAppCanadaStartCard.swift
//  Heartland-iOS-SDK
//

import Foundation

struct HpsUpaCAStartCardConstants {
    static let command: HpsUpaCAStartCardCommand = .SALE
}

public struct HpsUpaCAStartCard<T: Codable>: Codable {
    public var message: String
    public let data: HpsUpaCommandPayload<T>?

    public init(message: HpsUpaCAStartCardMessage = HpsUpaCAStartCardMessage.MSG,
...
public struct HpsUpaCAStartCardDataSaleDetails: Codable {
    public let params: HpsUpaCAStartCardParams?
    public let transaction: HpsUpaCAStartCardTransaction
    public let lodging: HpsUpaCAStartCardLodging?

    public init(params: HpsUpaCAStartCardParams?,
                transaction: HpsUpaCAStartCardTransaction,
                lodging: HpsUpaCAStartCardLodging?) {
        self.params = params
...
public struct HpsUpaCAStartCardParams: Codable {
...
public struct HpsUpaCAStartCardTransaction: Codable {
...
public struct HpsUpaCAStartCardLodging: Codable {
