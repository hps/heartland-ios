...
#   * Finally, don't worry about the indent, CocoaPods strips it!  
  ...
  s.frameworks = 'UIKit'
  s.vendored_frameworks = 'Heartland-iOS-SDK/Libraries/GlobalMobileSDK.xcframework', 
                        'Heartland-iOS-SDK/Libraries/GlobalPaymentsApi.xcframework', 
                        'Heartland-iOS-SDK/Libraries/BBPOS.xcframework', 
                        'Heartland-iOS-SDK/Libraries/TemLibrary.xcframework',
                        'Heartland-iOS-SDK/Libraries/LandiSDK_BLE.xcframework',
                        'Heartland-iOS-SDK/Libraries/RUA_BLE.xcframework' 
