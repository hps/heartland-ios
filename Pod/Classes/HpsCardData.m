...
- (NSString*) toXML
{
    ...
    NSString *xml = [NSString stringWithFormat:@"%@<hps:ManualEntry>%@%@%@%@%@%@</hps:ManualEntry>%@%@",requestXMLhead, expMonth, cardPresent, expYear, readerPresent, cardNumber,cvv, requestToken, requestXMLTail];
    return xml;
}
