...
@implementation HpsPaxGiftAddValueBuilder
...
- (void) execute:(void(^)(HpsPaxGiftResponse*, NSError*))responseBlock{
    ...
    [device doGift:messageId withTxnType:PAX_TXN_TYPE_ADD andSubGroups:subgroups withResponseBlock:^(HpsPaxGiftResponse *response, NSError *error) {
