...
@implementation HpsPaxCreditCaptureBuilder
...
- (void) execute:(void(^)(HpsPaxCreditResponse*, NSError*))responseBlock{
    ...
    [device doCredit:PAX_TXN_TYPE_POSTAUTH andSubGroups:subgroups withResponseBlock:^(HpsPaxCreditResponse *response, NSError *error) {
