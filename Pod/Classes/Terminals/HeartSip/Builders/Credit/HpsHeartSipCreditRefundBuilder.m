...
- (void) execute:(void(^)(id <IHPSDeviceResponse>, NSError*))responseBlock{
	...
	HpsHeartSipRequest *request_refund = [[HpsHeartSipRequest alloc]initWithCreditRefundRequestwithVersion:(self.version.stringValue ? self.version.stringValue :@"1.0") withEcrId:( self.ecrId ? self.ecrId :@"1004") withRequest:HSIP_MSG_ID_toString[CREDIT_REFUND] withCardGroup:self.cardGroup withConfirmAmount:(self.confirmAmount.stringValue ? self.confirmAmount.stringValue :@"0") withInvoiceNbr:self.invoiceNbr.stringValue withTotalAmount:self.totalAmount.stringValue];
