...
@implementation HpsHpaDebitRefundBuilder
...
- (void) execute:(void(^)(id<IHPSDeviceResponse>, NSError*))responseBlock{
	...
	[self validate];
	HpsHpaRequest *request_refund = [[HpsHpaRequest alloc]initWithDebitRefundRequestwithVersion:(self.version.stringValue ? self.version.stringValue :@"1.0") withEcrId:( self.ecrId ? self.ecrId :@"1004") withRequest:HPA_MSG_ID_toString[CREDIT_REFUND] withCardGroup:self.cardGroup withConfirmAmount:(self.confirmAmount.stringValue ? self.confirmAmount.stringValue :@"0") withInvoiceNbr:self.invoiceNbr.stringValue withTotalAmount:self.totalAmount.stringValue];
