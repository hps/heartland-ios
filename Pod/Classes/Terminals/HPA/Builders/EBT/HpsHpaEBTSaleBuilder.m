...
@interface HpsHpaEBTSaleBuilder()
...
@end
@implementation HpsHpaEBTSaleBuilder
...
- (void) execute:(void(^)(id<IHPSDeviceResponse>, NSError*))responseBlock{
    ...
    HpsHpaRequest *request_sale = [[HpsHpaRequest alloc]
                                   initWithEBTSaleRequestwithVersion:(self.version.stringValue ? self.version.stringValue :@"1.0")
